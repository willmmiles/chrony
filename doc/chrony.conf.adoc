...
*extendedinfo*::
This option adds Howard Stenn's draft '`Extended Information`' NTPv4
extension to request packets.  Note that this feature is not currently an
internet standard, and generally should not be enabled outside of a controlled
environment.
